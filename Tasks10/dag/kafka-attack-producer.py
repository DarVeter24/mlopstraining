...
def run_escalating_attack(**context) -> str:
    ...
    # Фазы атаки с увеличивающейся интенсивностью
    attack_phases = [
        {"name": "Фаза 1: Базовая нагрузка", "tps": 50, "duration_sec": 60, "records": 3000},
        {"name": "Фаза 2: Умеренная атака", "tps": 200, "duration_sec": 120, "records": 24000},
        {"name": "Фаза 3: Интенсивная атака", "tps": 500, "duration_sec": 180, "records": 90000},
        {"name": "Фаза 4: КРИТИЧЕСКАЯ АТАКА", "tps": 1500, "duration_sec": 300, "records": 450000}
    ]
