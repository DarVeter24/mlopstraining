...
![Simple Training Pipeline](./images/simple_training_pipeline.png)

На скриншоте показан DAG `simple_training_pipeline` в веб-интерфейсе Airflow, который выполняет периодическое переобучение модели обнаружения мошенничества с использованием PySpark и фиксацией всех метрик в MLFlow.

**Структура пайплайна обучения:**

![Training Pipeline Structure](./images/training_pipeline_structure.png)

Диаграмма демонстрирует архитектуру пайплайна обучения, включающую этапы загрузки данных, предобработки, обучения модели с PySpark, валидации и сохранения артефактов в MLFlow с интеграцией в MinIO хранилище.

**Выполнение задач обучения:**

![Simple Training Execution](./images/simple_training_execution.png)

Скриншот показывает успешное выполнение всех задач в пайплайне переобучения модели, включая загрузку данных, обучение с использованием PySpark, валидацию метрик и сохранение результатов в MLFlow для отслеживания экспериментов.
